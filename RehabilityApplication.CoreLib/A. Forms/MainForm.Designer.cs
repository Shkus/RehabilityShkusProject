namespace RehabilityApplication.CoreLib
{
    partial class MainForm
    {
		...
		private void InitializeComponent()
		{
			...
			btnSplashScreenShkus = new DevExpress.XtraBars.BarButtonItem();
			...
			groupDatabase.ItemLinks.Add(btnSplashScreenShkus);
			...
			PC.TabIndex = 2;
			// 
			// btnSplashScreenShkus
			// 
			btnSplashScreenShkus.Caption = "Показать сплэш скрин Василия";
			btnSplashScreenShkus.Id = 40;
			btnSplashScreenShkus.ImageOptions.SvgImage = (DevExpress.Utils.Svg.SvgImage)resources.GetObject("btnSplashScreenShkus.ImageOptions.SvgImage");
			btnSplashScreenShkus.Name = "btnSplashScreenShkus";
		...
		private DevExpress.XtraBars.BarButtonItem btnSplashScreenShkus;
	}
}